...
$connect = mysqli_connect("localhost", "root", "", "bookingcalendar");  
 ...
 <body>  
  <div class="container box">  
   <form action="" method="post" id="frmLogin"> 
    <h3 align="center">헝가리 한국문화원 미팅룸 예약 시스템</h3><br />
    ...
    <div class="form-group">  
     <div><input type="submit" name="login" value="Login" class="btn btn-success"><span></span></div>  
    </div>   
   </form>  
   <br />  
  </div>  
